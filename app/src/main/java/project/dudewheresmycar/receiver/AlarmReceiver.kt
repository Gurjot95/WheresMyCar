...
class AlarmReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        when (intent.action) {
            Constants.ACTION_SET_EXACT -> {
                // TODO: use R.string.notif_title & R.string.notif_message
    ...
    private fun buildNotification(context: Context, title: String, message: String) {
        ...
        val notificationBuilder = NotificationCompat.Builder(context, channelId)
            ...
            .addAction(R.drawable.ic_app_icon, "Snooze 15 minutes" , pendingIntent)
            //TODO: .addAction(R.drawable.ic_app_icon, getString(R.string.notif_snooze_15) , pendingIntent)
